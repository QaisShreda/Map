...
root=Tk()
root.title("Scale,Tabs,Table Example")
root.geometry("600x400")

scale1=Scale(root,label="Simple Scale",from_=0,to=100,command=getValue,fg="white",bg="green",activebackground="red",troughcolor="orange")
scale1.pack(fill="x")

scale2=Scale(root,label="Simple Scale Horizontal",from_=0,to=100,command=getValue2,fg="white",bg="green",activebackground="red",troughcolor="orange",orient="horizontal")
scale2.pack(fill="x")
